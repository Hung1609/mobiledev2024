...
public class WeatherAndForecastFragment extends Fragment {
    ...
    public void onViewCreated(View view,Bundle saveInstanceState){
        ...
        getChildFragmentManager().beginTransaction().replace(R.id.fragment_weather,weather).commit();

        Fragment forecast = new ForecastFragment();
        getChildFragmentManager().beginTransaction().replace(R.id.fragment_forecast,forecast).commit();
    }
}